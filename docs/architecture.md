...
| **Relationships** | What does this memory connect to, contradict, or replace? | `memory_links` (directed), near-duplicate links created by `Upsert`, scope-conflict exemption ([#563](https://github.com/wcatz/ghost/pull/563)) | Scope-conflicting edges are neither written nor applied ([#574](https://github.com/wcatz/ghost/issues/574)); contradiction and supersede invariants are below |
