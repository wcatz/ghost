...
- Hybrid search: 70% vector (cosine, Ollama) + 30% FTS5, RRF fusion — `FuseAndSelectWindow` owns scope narrowing, keyword reservation, and the final candidate cut, including the FTS-only degenerate path
